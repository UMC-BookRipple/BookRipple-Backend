...
import com.bookripple.api.domain.blindsalepost.code.BlindSalePostErrorCode;
...
public class BlindSalePostServiceImpl implements BlindSalePostService {
  ...
  public BlindSalePostResDto.PurchaseRequestList getPurchaseRequests(Long blindPostId) {
    ...
    // 2. 구매 요청자 명단만 조회
    List<PurchaseRequest> requests = purchaseRequestRepository.findAllByBlindSalePostId(
        blindPostId);
  ...
  @Override
  public BlindSalePostResDto.SliceResponse getMyPostList(Long memberId, PostStatus status,
    ...
    List<BlindSalePost> posts = (cursor == null)
        ? blindSalePostRepository.findAllByMemberIdAndPostStatusOrderByIdDesc(memberId, status,
        pageable)
        : blindSalePostRepository.findAllByMemberIdAndPostStatusAndIdLessThanOrderByIdDesc(memberId,
  ...
  @Override
  public BlindSalePostResDto.BuyerSliceResponse<BlindSalePostResDto.BuyerListElement> getAllPosts(
      Long cursor, int size) {
    ...
    List<BlindSalePost> posts = (cursor == null)
        ...
        : blindSalePostRepository.findAllByPostStatusAndIdLessThanOrderByIdDesc(PostStatus.SALE,
            cursor, pageable);
  ...
  // 2. 내가 요청한 책 목록 (오른쪽 탭)
  @Override
  public BlindSalePostResDto.BuyerSliceResponse<BlindSalePostResDto.MyRequestListElement> getMyRequests(
    ...
    List<PurchaseRequest> requests = (cursor == null)
        ...
        : purchaseRequestRepository.findAllByMemberIdAndIdLessThanOrderByIdDesc(memberId, cursor,
            pageable);
